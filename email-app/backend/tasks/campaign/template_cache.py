...
{body_content}
    ...
    def _personalize_content(self, content: str, context: Dict[str, Any],
        ...
        try:
            ...
            # Simple {{ var }} replacement for basic templates
