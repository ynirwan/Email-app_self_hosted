...
class Settings:
    ...
    MONGODB_URI: str = os.getenv("MONGODB_URI", "mongodb://127.0.0.1:27017/email_app")
    ...
    CELERY_BROKER_URL: str = os.getenv("REDIS_URL", "redis://127.0.0.1:6379/0")
    CELERY_RESULT_BACKEND: str = os.getenv("REDIS_URL", "redis://127.0.0.1:6379/0")
