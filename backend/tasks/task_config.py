...
class TaskSettings:
    ...
    # ===== HYBRID RECOVERY =====
    ENABLE_HYBRID_RECOVERY: bool = (
        os.getenv("ENABLE_HYBRID_RECOVERY", "true").lower() == "true"
    )
    ...
    HEALTH_CHECK_STRICT_MODE: bool = (
        os.getenv("HEALTH_CHECK_STRICT_MODE", "false").lower() == "true"
    )
    ENABLE_HEALTH_CHECK_BLOCKING: bool = (
        os.getenv("ENABLE_HEALTH_CHECK_BLOCKING", "false").lower() == "true"
    )
    SKIP_HEALTH_CHECKS_FOR_TESTING: bool = (
        os.getenv("SKIP_HEALTH_CHECKS_FOR_TESTING", "false").lower() == "true"
    )
    ...
    ENABLE_BULK_OPTIMIZATIONS: bool = (
        os.getenv("ENABLE_BULK_OPTIMIZATIONS", "true").lower() == "true"
    )
    ...
    ENABLE_COMPLIANCE_TRACKING: bool = (
        os.getenv("ENABLE_COMPLIANCE_TRACKING", "false").lower() == "true"
    )
    ...
    PRODUCTION_SAFETY_MODE: bool = (
        os.getenv("PRODUCTION_SAFETY_MODE", "true").lower() == "true"
    )
