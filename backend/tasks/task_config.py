...
class TaskSettings:
    ...
    WORKER_MAX_TASKS_PER_CHILD: int = int(
        os.getenv("WORKER_MAX_TASKS_PER_CHILD", "500"))
    ...
    # ===== EMAIL SENDING =====
    EMAIL_SEND_TIMEOUT_SECONDS: int = int(
        os.getenv("EMAIL_SEND_TIMEOUT_SECONDS", "30"))
    ...
    # ===== RATE LIMITING =====
    ENABLE_RATE_LIMITING: bool = os.getenv("ENABLE_RATE_LIMITING",
                                           "true").lower() == "true"
    ...
    DLQ_RETRY_DELAY_MINUTES: int = int(
        os.getenv("DLQ_RETRY_DELAY_MINUTES", "15"))
    ...
    # ===== HYBRID RECOVERY =====
    ENABLE_HYBRID_RECOVERY: bool = os.getenv("ENABLE_HYBRID_RECOVERY",
                                             "true").lower() == "true"
    ...
    # ===== METRICS & MONITORING =====
    ENABLE_METRICS_COLLECTION: bool = os.getenv("ENABLE_METRICS_COLLECTION",
                                                "true").lower() == "true"
    METRICS_COLLECTION_INTERVAL_SECONDS: int = int(
        os.getenv("METRICS_COLLECTION_INTERVAL_SECONDS", "60"))
    METRICS_RETENTION_HOURS: int = 24
    METRICS_AGGREGATION_INTERVAL_SECONDS: int = 300
    ENABLE_RESOURCE_MONITORING: bool = os.getenv("ENABLE_RESOURCE_MONITORING",
                                                 "true").lower() == "true"
    MEMORY_THRESHOLD_PERCENT: float = 85.0
    CPU_THRESHOLD_PERCENT: float = 90.0
    DISK_THRESHOLD_PERCENT: float = 90.0
    RESOURCE_CHECK_INTERVAL_SECONDS: int = 60
    MAX_MEMORY_USAGE_PERCENT: float = float(
        os.getenv("MAX_MEMORY_USAGE_PERCENT", "85.0"))
    MAX_DISK_USAGE_PERCENT: float = float(
        os.getenv("MAX_DISK_USAGE_PERCENT", "90.0"))
    MAX_CPU_USAGE_PERCENT: float = float(
        os.getenv("MAX_CPU_USAGE_PERCENT", "80.0"))
    ...
    DATABASE_RESPONSE_TIME_THRESHOLD: float = float(
        os.getenv("DATABASE_RESPONSE_TIME_THRESHOLD", "2.0"))
    HEALTH_CHECK_STRICT_MODE: bool = os.getenv("HEALTH_CHECK_STRICT_MODE",
                                               "false").lower() == "true"
    ENABLE_HEALTH_CHECK_BLOCKING: bool = os.getenv(
        "ENABLE_HEALTH_CHECK_BLOCKING", "false").lower() == "true"
    SKIP_HEALTH_CHECKS_FOR_TESTING: bool = os.getenv(
        "SKIP_HEALTH_CHECKS_FOR_TESTING", "false").lower() == "true"

    # ===== SUBSCRIBER PROCESSING =====
    SUBSCRIBER_PROCESSING_TIMEOUT: int = int(
        os.getenv("SUBSCRIBER_PROCESSING_TIMEOUT", "300"))
    MAX_RECORDS_PER_OPERATION: int = int(
        os.getenv("MAX_RECORDS_PER_OPERATION", "50000"))
    ENABLE_BULK_OPTIMIZATIONS: bool = os.getenv("ENABLE_BULK_OPTIMIZATIONS",
                                                "true").lower() == "true"
    SUBSCRIBER_IMPORT_CHUNK_SIZE: int = 1000
    DUPLICATE_CHECK_ENABLED: bool = True

    # ===== AUDIT & COMPLIANCE =====
    ENABLE_AUDIT_LOGGING: bool = os.getenv("ENABLE_AUDIT_LOGGING",
                                           "true").lower() == "true"
    ENABLE_COMPLIANCE_TRACKING: bool = os.getenv("ENABLE_COMPLIANCE_TRACKING",
                                                 "false").lower() == "true"
    ...
    SES_CRITICAL_BATCH_SIZE: int = int(
        os.getenv("SES_CRITICAL_BATCH_SIZE", "50"))
    ...
    PRODUCTION_SAFETY_MODE: bool = os.getenv("PRODUCTION_SAFETY_MODE",
                                             "true").lower() == "true"
    ENABLE_STRUCTURED_LOGGING: bool = True
    ENABLE_GRACEFUL_SHUTDOWN: bool = True
    ENABLE_PERFORMANCE_LOGGING: bool = os.getenv("ENABLE_PERFORMANCE_LOGGING",
                                                 "true").lower() == "true"
